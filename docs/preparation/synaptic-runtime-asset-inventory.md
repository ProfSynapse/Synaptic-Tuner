...
| Modal training wrapper | `Trainers/cloud/train_modal.py` | `ModalBackend` validates and passes this repository-relative script to `modal run` | Package/provision as a provider entry point or use exact checkout reconstruction |
