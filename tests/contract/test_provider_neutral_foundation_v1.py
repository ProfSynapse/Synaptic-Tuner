...
import synaptic_tuner.api.v1.pipelines_facade
...
def test_foundation_source_has_no_forbidden_imports() -> None:
    paths = [
        ...
        for name in ("_contract.py", "providers.py", "planning.py", "results.py", "training_facade.py", "runs_facade.py", "artifacts_facade.py", "observations.py", "usage.py", "ports.py", "evaluation_facade.py", "data_facade.py", "pipelines_facade.py", "reference/__init__.py", "reference/stores.py")
    ]
    for path in paths:
