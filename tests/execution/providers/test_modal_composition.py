...
def test_single_composition_root_selects_production_verification_algorithms():
    ports=HostPorts(lifecycle=object(),runs=object(),grants=object(),secrets=object(),evidence_replay=Replay(),authenticator=Auth(),clock=lambda:"2026-08-25T12:00:00Z",git_remote=Remote(),modal_reads=Facade(_deployment()),training_resolver=object())
