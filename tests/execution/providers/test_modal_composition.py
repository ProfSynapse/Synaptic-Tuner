...
from tuner.execution.providers.modal.composition import ModalSourceVerificationPorts,ModalVerificationPolicyV1,compose_modal_source_finalizer
...
def test_single_composition_root_selects_production_verification_algorithms():
    ports=ModalSourceVerificationPorts(evidence_replay=Replay(),authenticator=Auth(),clock=lambda:"2026-08-25T12:00:00Z",git_remote=Remote(),deployment_reads=Facade(_deployment()))
