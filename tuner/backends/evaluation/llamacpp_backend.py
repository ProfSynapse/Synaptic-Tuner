...
class LlamaCppBackend(IEvaluationBackend):
    ...
    def list_models(self) -> List[str]:
        ...
        # quantized/served through llama.cpp, so scanning embedding_output/ here
        # would surface dirs this backend cannot serve. Do not "fix" the apparent
        # inconsistency with the train-time method gates.
