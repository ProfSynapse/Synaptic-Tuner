...
Write-Host "â•‘            Toolset-Training Interactive CLI                   â•‘" -ForegroundColor Cyan
Write-Host "â•‘         SFT `& KTO Training for RTX 3090 / 4090                â•‘" -ForegroundColor Cyan
...
if ($Mode -eq "kto" -or $Mode -eq "pipeline") {
    ...
    if ($Mode -eq "kto") {
        Write-Host "    - Model: (from config.yaml)" -ForegroundColor Gray
    } else {
...
if ($Mode -eq "sft") {
    ...
    if ($SftOutputDirs) {
        ...
        Write-Host ""
        Write-Host "âœ“ SFT Training Complete!" -ForegroundColor Green
    ...
    if ($KtoOutputDirs) {
        ...
        Write-Host ""
        Write-Host "âœ“ KTO Training Complete!" -ForegroundColor Green
...
"@
    ...
    Write-Host "â•‘  âœ“ Complete SFT->KTO Pipeline Finished Successfully!          â•‘" -ForegroundColor Green
