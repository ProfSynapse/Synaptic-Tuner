...
# Diagnostic: Check if we can get past this point
Write-Host "[DEBUG] About to display menu options..." -ForegroundColor Magenta

$Option1 = "  1) SFT Only           - Supervised Fine-Tuning (teaches tool-calling)"
$Option2 = "  2) KTO Only           - Preference Learning (refines existing model)"
$Option3 = "  3) SFT -> KTO Pipeline - Full training pipeline (recommended)"
$Option4 = "  4) Exit"
