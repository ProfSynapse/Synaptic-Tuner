...
**File:** [SynthChat settings](../../../SynthChat/config/settings.yaml)
...
Profiles are defined in the [privacy profiles configuration](../../../SynthChat/config/privacy_profiles.yaml).
...
Runtime rules are config-driven through the [environment execution configuration](../../../Evaluator/config/environment_execution.yaml)
...
- [Quick-check target manifest](../../../SynthChat/config/targets_cli_existing_tools_quickcheck.json)
- [Representative target manifest](../../../SynthChat/config/targets_cli_existing_tools_representative.json)

---

## Validation Configuration

**File:** [SynthChat validation configuration](../../../SynthChat/config/validation.yaml)
